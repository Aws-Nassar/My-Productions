...
def page():
    ...
    list = []
    rootPage = ctk.CTk()
    rootPage.title("The Council of Engineering Offices and Companies Authority(1)")
    window_width = 700
    window_height = 495
    ...
    cursor.execute(""" select technical_affairs_offices, Classification_Number from ranktemp""")
