...
def page():
    ...
    app.geometry(f"{window_width}x{window_height}+{x_position}+{y_position-30}")
    ...
    insert_button.place(x =17 ,y =630)
    ...
    def nextPage():
        ...
        if counter < len(find):
            messagebox.showwarning(title='Incomplete entry', message='You need to enter all of your office full-time engineers')
            return
    ...
    close_button.place(x =623 ,y =630)
    style = ttk.Style(app)
