...
def page():
    ...
    rootPage = ctk.CTk()
    rootPage.title("The Director of the Financial Affairs Department(1)")
    window_width = 700
    window_height = 495
    ...
    font = ("Arial", 20, "bold")
    requsetsLabel = ctk.CTkLabel(rootPage, text="Requests:", font=font, text_color="white", bg_color="#161C25")
    ...
    cursor.execute(""" select office_official_flag, Classification_Number from ranktemp""")
