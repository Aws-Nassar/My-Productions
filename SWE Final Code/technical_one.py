...
def page():
    ...
    rootPage = ctk.CTk()
    rootPage.title("The Director of Technical Affairs(1)")
    window_width = 700
    window_height = 495
    ...
    cursor.execute(""" select engineering_offices_flag, Classification_Number from ranktemp""")
